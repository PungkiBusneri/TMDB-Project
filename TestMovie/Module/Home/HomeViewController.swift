...
class HomeViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        textFieldSearch.backgroundColor = .systemPink
    }
    ...
    func setupComponent() {
        setupRefreshControl()
        textFieldSearch.addPaddingAndIcon(UIImage.icSearch, padding: 10, isLeftView: false)
        ...
        textFieldSearch.attributedPlaceholder = NSAttributedString(
            string: "Search your favorite films, Drama, Comedy, War",
            attributes: [NSAttributedString.Key.foregroundColor: UIColor.white]
        )
        textFieldSearch.textColor = .white
        textFieldSearch.font?.withSize(18)
    }
